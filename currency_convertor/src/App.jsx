...
function App() {
  ...
  return (
    <div
        className="w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat rounded-lg"
            ...
            <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-black/30">
                <form onSubmit={(e) => {
                    ...
                    <div className="w-full mt-1 mb-4">
                        ...
                        onCurrencyChange={(currency) => setTo(currency)} selectcurrency={to} amountDisabled/>
                    </div>
